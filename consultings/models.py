...
class Consulting(core_models.TimeStampedModel):

    """ Consulting Model Definition """
    STUDENT_M_1 = "m1"
    STUDENT_M_2 = "m2"
    STUDENT_M_3 = "m3"
    STUDENT_H_1 = "h1"
    ...
    student_grade = models.CharField(max_length=20, choices=STUDENT_CHOICES, default='')
    ...
    consulting_time = models.CharField(max_length=12, choices=TIME_CHOICES, default='')
